...
import { BasicClubStatus } from "../ClubStatus";
      ...
      fc
        .asyncProperty(
          ...
          async (fcGen, testNumbers) => {
            ...
            const expectedValueCreator = (
              expectedValueName: string,
              expectedValue: number,
            ): string => `${expectedValueName}: ${expectedValue}`;

            const expectedFinances: Array<string> = zipWith(
              expectedValueCreator,
              expectedClubFinanceNames,
              testClubFinances,
            );
            ...
            const TestElement = () => {
              return (
                <div>
                  <BasicClubStatus
                    baseCountries={testBaseCountries}
                    clubDetails={testBasicClubDetails}
                    clubFinances={testClubFinances}
                  />
                </div>
              );
            };
